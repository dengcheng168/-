/*
  ...
  - You are about to drop the column `twitterPixelId` on the `site_settings` table. All the data in the column will be lost.
...
INSERT INTO "new_site_settings" ("companyAddress", "companyEmail", "companyLogoUrl", "companyName", "companyPhone", "coreAdvantages", "defaultOgImage", "defaultSeoDescription", "defaultSeoTitle", "factoryPhotos", "factoryStats", "footerColumns", "footerCompanyIntro", "footerText", "googlePixelId", "heroButton1Link", "heroButton1Text", "heroButton2Link", "heroButton2Text", "heroDesktopImage", "heroHeadline", "heroMobileImage", "heroSubheadline", "id", "metaPixelId", "oemProcessSteps", "partnerRegions", "smtpEnabled", "smtpFromEmail", "smtpHost", "smtpPassword", "smtpPort", "smtpUser", "socialLinks", "stats", "tiktokPixelId", "turnstileEnabled", "turnstileSecretKey", "turnstileSiteKey", "updatedAt", "whatsappLink", "whatsappNumber") SELECT "companyAddress", "companyEmail", "companyLogoUrl", "companyName", "companyPhone", "coreAdvantages", "defaultOgImage", "defaultSeoDescription", "defaultSeoTitle", "factoryPhotos", "factoryStats", "footerColumns", "footerCompanyIntro", "footerText", "googlePixelId", "heroButton1Link", "heroButton1Text", "heroButton2Link", "heroButton2Text", "heroDesktopImage", "heroHeadline", "heroMobileImage", "heroSubheadline", "id", "metaPixelId", "oemProcessSteps", "partnerRegions", "smtpEnabled", "smtpFromEmail", "smtpHost", "smtpPassword", "smtpPort", "smtpUser", "socialLinks", "stats", "tiktokPixelId", "turnstileEnabled", "turnstileSecretKey", "turnstileSiteKey", "updatedAt", "whatsappLink", "whatsappNumber" FROM "site_settings";
