...
import { listCertificates } from '@/lib/api/content';
...
export default async function CertificatesPage() {
  ...
  return (
    <Container className="py-12">
      ...
      <p className="mt-3 max-w-2xl text-grey-500">
        We maintain compliance with relevant international quality and safety standards.
      </p>
